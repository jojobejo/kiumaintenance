...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 11 Nov 2024 pada 09.59
...
--
-- Struktur dari tabel `tb_kpi_indikator`
--

CREATE TABLE `tb_kpi_indikator` (
  `id` int(11) NOT NULL,
  `kode_user` varchar(25) NOT NULL,
  `nm_poin` text NOT NULL,
  `bobot_poin` int(11) NOT NULL,
  `create_at` date NOT NULL,
  `status` int(2) NOT NULL,
  `last_updatedby` varchar(25) NOT NULL,
  `update_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data untuk tabel `tb_kpi_indikator`
--

INSERT INTO `tb_kpi_indikator` (`id`, `kode_user`, `nm_poin`, `bobot_poin`, `create_at`, `status`, `last_updatedby`, `update_at`) VALUES
(1, 'KIU1007230002', 'Testing Nama Indikator', 75, '2024-11-11', 0, 'KIU1007230002', '2024-11-11 08:41:31'),
(3, 'KIU1007230002', 'EXPL Nama Indikator ', 50, '2024-11-11', 0, 'KIU1007230002', '2024-11-11 07:04:27');

-- --------------------------------------------------------

--
-- Struktur dari tabel `tb_kpi_what`
--

CREATE TABLE `tb_kpi_what` (
  `id` int(11) NOT NULL,
  `kode_user` varchar(25) NOT NULL,
  `id_kpi_indikator` int(11) NOT NULL,
  `nm_what` text NOT NULL,
  `hasil_what` text NOT NULL,
  `bobot_what` int(11) NOT NULL,
  `create_at` date NOT NULL,
...
(1, '2024-11-01', '12:56', 'Bisi', 'Bram', '-', '-', 3, 'RE-SCHEDULE', '', '2024-11-04 02:16:29'),
(2, '2024-11-01', '15:59', '111', '111', '111', '111', 1, '-', '', '2024-11-01 08:59:31'),
(5, '2024-11-11', '08:33', '-', '-', '-', '-', 3, 'RE-SCHEDULE', '', '2024-11-11 01:33:46');
...
INSERT INTO `tb_user` (`id`, `nik`, `kode_user`, `nama_user`, `nama_lengkap`, `departemen`, `sub_departemen`, `alamat`, `tgl_lahir`, `username`, `password`, `akses_lv`, `create_at`) VALUES
(1, '', 'KIU1007230001', 'SUPERADMIN', '', 'IT', '', '', '', 'admin', '$2y$10$MGM1lvOhXAOJA8qN7E6ddOtoiy6IwRKmE4NOFvs9vDOXrgbJYPZGi', 1, '2023-08-22 05:58:36'),
(2, '', 'KIU1007230002', 'Maulana Malik Ibrahim', 'MAULANA MALIK IBRAHIM', 'KEUANGAN', 'IT Software', '', '', 'bram', '$2y$10$KeBGAKJTXGYXt39wb.FZYedFST5fbIuxQ8hRcHRsYTxsauhoxyNbO', 3, '2024-11-11 02:43:52'),
...
--
-- Indeks untuk tabel `tb_kpi_indikator`
--
ALTER TABLE `tb_kpi_indikator`
  ADD PRIMARY KEY (`id`);

--
-- Indeks untuk tabel `tb_kpi_what`
--
ALTER TABLE `tb_kpi_what`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT untuk tabel `tb_kpi_indikator`
--
ALTER TABLE `tb_kpi_indikator`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT untuk tabel `tb_kpi_what`
--
ALTER TABLE `tb_kpi_what`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
